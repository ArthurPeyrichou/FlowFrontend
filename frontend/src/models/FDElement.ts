...
export class FDElement {
     ...
     * @param notes string.
     * @param state unknown Object.
     * @param links Map Object.
     */
    constructor (id: string, aFDComponent: FDComponent, tabId: string, name: string, color: string, x: number | string, y: number | string, notes: string, state: unknown, options: unknown, links: Map<number, Array<{index: number; id: string}>>) {
      this.id = id
